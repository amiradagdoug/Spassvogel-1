        ...
        <Container className='contentPage'>
            ...
            <Row className=" my-5">
                <div className="col-md-3 my-2">
                    ...
                    <Link to={{ pathname: '/dadjoke' }} className='actionButton act'>
                        Dadjokes  &gt;
                    </Link>
                ...
                <div className="col-md-9 my-2">
                    <h2 className='my-4 mt-0'>Dadjokes</h2>
                    ...
                    <button className='mt-5 actionButtonLeft' onClick={addNewContact}>Neue DadJoke hinzufügen +</button>&nbsp;
